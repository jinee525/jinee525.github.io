...
const skills = {
  main: ['React', 'JavaScript ', 'CSS', 'Responsive Web', 'GraphQL', 'Sequelize', 'AWS', 'ReactAdmin'],
  sub: ['Django', 'Python', 'React-Native', 'next.js', 'TypeScript', 'PostgreSQL'],
};
...
const jobs = [
  {
    ...
    date: '2020.07.07 ~ 2021.01.08 ~ 2022.07.13',
    summary:
      '6인으로 이루어진 프로덕트 팀에서 풀스택 웹 개발자로 근무했습니다.\n유저와 만나는 웹/앱 프런트부터 서비스를 지탱하는 백엔드까지, 크고 작은 프로젝트들을 주도적으로 진행했습니다.\nAWS의 다양한 클라우드 서비스로 BE 개발을 했고, React 중심으로 FE 개발을 했습니다.',
    projects: [
      {
        title: '배너 자동화',
        content:
        ...
        solutions: [
          ...
          ['유저 그룹에 따라 다른 배너 노출이 필요함', '배너 노출 조건(기간, 대상 등) 설정을 포함한 배너 관리 시스템을 개발함'],
        ],
      },
      {
        title: '쿠폰 패키지',
        ...
        solutions: [
          ...
          ['새로운 상품에 대한 유저 문의가 발생함', 'CX팀과 협업하여 "문제점 정의 -> UX/UI 개선 -> CS 데이터 확인" 과정을 반복하며 개선함'],
        ],
      },
      {
        title: '외부 서비스 등록 자동화',
        content: '관리자 편의와 유저의 서비스 경험 개선을 위해 외부 서비스 자동 등록 프로세스를 구현했습니다.',
        boundary: ['BE'],
      ...
      {
        title: '검색 기능',
        content: '유저 경험을 개선하고 판매율을 증가시키기 위해 콘텐츠를 카테고리로 필터링하고 키워드로 검색하는 기능을 구현했습니다.',
        boundary: ['FE', 'BE'],
      ...
      },
      {
        ...
        url: '',
        solutions: [
          ['AWS 작업을 코드로 관리하고 싶음', '코드로 severless를 관리할 수 있도록 AWS 설정 스크립트를 작성함'],
          [
            '테스트 코드를 통한 품질 확보',
      ...
      {
        title: '블로그',
        content: '사이트 내에서 다양한 컨텐츠를 제공하여 유저의 유입과 체류 시간을 늘리기 위해 블로그 페이지를 구현했습니다.',
        boundary: ['FE'],
      ...
      },
      {
        ...
        content: '등록된 계정을 찾고, 비밀번호를 재설정하는 과정을 단계별로 쪼개 API를 구현하여 유저 편의를 높였습니다.',
        boundary: ['FE', 'BE'],
      ...
      {
        title: '웹/앱 개편',
        content: '앱 이용자 수를 늘리기 위해 사용성을 개선하고 앱에서만 사용할 수 있는 기능을 추가했습니다.',
        boundary: ['FE'],
        tech: ['React-Native', 'next.js', 'TypeScript'],
        url: '',
        solutions: [
          ['앱 사용성을 높여 유저 수를 증가시키고 싶음', '앱 친화적인 UX/UI를 사용하여 앱 전용 기능을 구현함'],
          [
      ...
      {
        title: '쿠폰 시스템 리뉴얼',
        content: '쿠폰의 사용성을 높여 비즈니스에 적극 활용할 수 있도록 기존 쿠폰 시스템을 개선했습니다.',
        boundary: ['BE'],
      ...
      },
      {
        ...
        content: '기업 교육을 통해 새로운 수익 모델을 만들고 회원 수 증가를 위해 B2B 시스템을 개발했습니다.',
        boundary: ['FE', 'BE'],
        ...
        solutions: [
          ...
          ['일반 유저와 기업 유저의 서비스 경험을 다르게 하고 싶음', '유저의 상태 값에 따라 보여지는 화면이 달라지도록 구현함'],
        ],
      },
    ],
  },
