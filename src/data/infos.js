...
const jobs = [
  {
    ...
    projects: [
      ...
      },
      {
        ...
        solutions: [['외부 사이트에서 제공되었던 컨텐츠를 서비스 내부에서 제공하여 유저의 유출을 막고 싶음', '블로그 형식의 글을 제공하는 페이지를 구현함, 타입별로 필터링 할 수 있음']],
      },
      {
      ...
      },
      {
        ...
        url: '',
        solutions: [['앱 사용성을 높여 유저 수를 증가시키고 싶음', '앱 친화적인 UX/UI를 사용하여 앱 전용 기능을 구현함'], ['사이트 접근 및 외부 공유 경험 개선 필요', '링크 공유 시 미리 보이는 썸네일&설명 데이터가 중요하거나 검색(seo)이 중요한 페이지를 Next.js로 개발하여 SPA의 단점을 보완함']],
      },
      {
        title: '쿠폰 시스템 리뉴얼',
        content:
